   ...
   // request.resource.size <2 *1024 * 1024 &&
    ...
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <Link className='text-center bg-green-700 p-3 rounded-lg
        uppercase hover:opacity-95 text-white' to={'/create-listing'} >
          Create Listing
        </Link>
      ...
      className='text-gray-700 w-full'>Show Listings</button>
      ...
      {userListings && userListings.length >0 &&
         <div className='flex flex-col gap-4'>
          <h1 className='text-center mt-7 text-2xl font-semibold'>Your Listings</h1>
           {userListings.map((listing)=>  <div key={listing._id} className='border gap-4 flex justify-between items-center rounded-lg p-3'>
              <Link to={`/listing/${listing._id}`}>
                <img className=' w-17 h-16 rounded-lg object-contain'
